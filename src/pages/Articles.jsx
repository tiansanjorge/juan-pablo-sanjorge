  ...
  return (
    <main className="topFiller">
      <section className="container-fluid">
        <div className="row">
          <div className="col-12 fondoVerdeC d-flex flex-column justify-content-evenly py-3 px-0">
            ...
            <div className="Col-10 d-flex flex-column justify-content-evenly pt-3 pb-4">
              {ArticlesArray.map((articulo,index) => {
                ...
                return (
                  <Link className="text-decoration-none" to={`/articles/${articleId}`} key={index}>
